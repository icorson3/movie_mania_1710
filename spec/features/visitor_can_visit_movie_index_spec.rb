...
describe "As an unregistered visitor" do
  context "when i visit the movie index" do
    before :each do
      ...
      @genre_movie_1 = GenreMovie.create(movie_id: @movie, genre_id: @genre_1)
      @genre_movie_2 = GenreMovie.create(movie_id: @movie, genre_id: @genre_2)
      @genre_movie_3 = GenreMovie.create(movie_id: @movie, genre_id: @genre_3)
